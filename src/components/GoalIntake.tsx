...
import { Sparkles, Calendar, ArrowRight, Mic, MicOff, AlertCircle } from 'lucide-react';
      ...
      {!isLoading && (
        <div className="mt-4 pt-4 border-t border-gray-100">
          ...
          >
            ...
            <span className="ml-auto text-[10px] font-mono text-red-400 group-hover:text-red-500 bg-red-50 border border-red-100 px-2 py-0.5 rounded-full">TRIAGE MODE</span>
          </button>
        </div>
      )}
